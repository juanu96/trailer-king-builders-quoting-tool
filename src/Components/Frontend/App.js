...
const App = function (props) {
  ...
  const [personalInfo, setPersonalInfo] = useState({ firstName: '', lastName: '', email: '', phone: null, company: '', state: '', financing: false, creditScore: null })
  const { Step } = Steps

  return (
    <ApolloProvider client={client}>
      <QuoteStore.Provider value={{
        step,
        setStep,
        vehicleType,
        setVehicleType,
          ...
          <Row>
            <Col xs={12} sm={12} md={1}>
              <FadeIn delay={100} transitionDuration={500}>
                <Steps current={step - 1} className='desktop' direction='vertical'>
                  <Step />
                  <Step />
                  <Step />
                  <Step />
              ...
              <Steps current={step - 1} className='mobile mb-5' direction='horizontal'>
                <Step />
                <Step />
                <Step />
                <Step />
